...
export interface ApiBreweryBrewery extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    slug: Attribute.UID<'api::brewery.brewery', 'name'>;
    ...
    products: Attribute.Relation<
      ...
      'api::product.product'
    >;
    connected_kegs: Attribute.Relation<
      'api::brewery.brewery',
      'oneToMany',
      'api::product.product'
    >;
    stock_movements: Attribute.Relation<
      'api::brewery.brewery',
      'oneToMany',
      'api::stock-movement.stock-movement'
    >;
    tap_count: Attribute.Integer & Attribute.DefaultTo<0>;
...
export interface ApiConnectedKegConnectedKeg extends Schema.CollectionType {
  collectionName: 'connected_kegs';
  info: {
    singularName: 'connected-keg';
    pluralName: 'connected-kegs';
  ...
  attributes: {
    product: Attribute.Relation<
      ...
      'api::product.product'
    >;
    quantity_total: Attribute.Decimal;
    quantity_remaining: Attribute.Decimal;
    date_attached: Attribute.DateTime;
    formats: Attribute.JSON;
    is_active: Attribute.Boolean;
    brewery: Attribute.Relation<
      'api::connected-keg.connected-keg',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<
      ['Birra', 'Food', 'Vini', 'Superalcolici', 'Altro']
    >;
...
export interface ApiStockMovementStockMovement extends Schema.CollectionType {
  ...
  attributes: {
    ...
    unit: Attribute.Enumeration<['pezzi', 'litri']>;
